...
- 2026-07-20：✅ Phase 1 全部 6 课笔记完成（全景/环境/参数量/量化/显存精算/选卡实战）。
- 2026-07-20：✅ Phase 2 全部 6 课笔记完成（策略梯度/PPO-clip/KL/优势估计/GRPO推导/算法对比）。
- 2026-07-20：✅ Phase 3 全部 6 课笔记完成（单控制器/DataProto/parquet/数据流/batch体系/3D-HybridEngine）。
- 2026-07-20：✅ Phase 4 全部 5 课笔记完成（数据预处理/小资源LoRA/集群8B/参数精讲/OOM决策树）+ 3 个可运行脚本。
- 2026-07-20：✅ Phase 5 全部 6 课笔记完成（并行原语/FSDP/Megatron/并行映射/显存重分配/多机多卡）。
- 2026-07-20：✅ Phase 6 全部 7 课笔记完成（reward设计/compute_score/RewardManager/hacking/评测集/指标体系/观测）+ my_reward.py。
- 2026-07-20：✅ Phase 7 全部 6 课笔记完成（调优/调参手册/异常诊断/Agentic/生产checklist/复盘）。**全部 42 课完成。**
